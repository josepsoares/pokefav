        ...
        return (
            <Navbar light expand="md" className='mb-5'>
                <Link className='navBrandLink' to='/'>
                    <img alt={'Pokéfav'} src={require('../../assets/imgs/title.png')} />
                </Link>
                <IconButton style={{ borderColor: 'none' }} className="navbar-toggler" onClick={this.toggle} type="button">
                    <MenuRoundedIcon fontSize='large' style={{ color: '#ffe066' }} />
                </IconButton>
                <Collapse isOpen={this.state.isOpen} className='mt-3 mt-md-0' navbar>
                    <Nav className="ml-auto" navbar>
                        ...
                        <NavItem>
                            <NavLink
                                onClick={() => { getPokedex('national'); getDataPokeListPage() }}
