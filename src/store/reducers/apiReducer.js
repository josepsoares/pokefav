    ...
    switch (action.type) {
        ...
        case 'POKEMONINFO_ALTERNATEFORM_DATA_SUCCESS':
            return {
                ...
                error: null,
                apiData: {
                    ...state.apiData, getAlternateForms: action.payload
                }
            }
        ...
        case 'YOUTEBE_DATA_SUCCESS':
            return {
                ...state,
                isLoading: false,
                apiData: { ...state.apiData, getPokemonVideos: action.payload, errorYtData: null }
            }
        case 'YOUTEBE_DATA_ERROR':
            return {
                ...state,
                isLoading: false,
                apiData: { ...state.apiData, getPokemonVideos: action.payload, errorYtData: action.errorYtData.error.errors[0].message }
            }
